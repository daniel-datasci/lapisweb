...
export const blogPosts: BlogPost[] = [
  {
    ...
    body: [
      ...
      '## Where to start',
      "If you want to know what your competitors changed this week without giving someone another job, start with a free 30-minute discovery call. We'll talk through where your team's time goes and which AI workers to hire first. A Market Watch AI worker can be added to any plan for $1,000/month, and it may well be one of them.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      '## Find your leak',
      "Most businesses have never measured how many enquiries go unanswered, or how long replies really take. That's part of what the AI Opportunity Audit ($490, credited in full if you subscribe within 30 days) is for. We'll review your enquiry channels and lead handling, show you where leads go unanswered and how long replies take, and rank what's worth fixing first. If you'd rather talk it through first, book a free 30-minute discovery call.",
    ],
  },
  {
