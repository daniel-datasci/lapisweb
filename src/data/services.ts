...
export const services: Service[] = [
  {
    ...
    delivery: {
      ...
      short: `Sold as the AI Opportunity Audit (${formatPrice(AUDIT_PRICE)}) and the Fractional Head of AI retainer.`,
      items: [
        auditItem(
          'Paid audit · 2 weeks',
        ...
        ),
        {
          ...
          price: monthlyPrice(FRACTIONAL_PRICE),
          to: '/pricing#projects',
    ...
    delivery: {
      ...
      items: [
        ...
        ),
        {
          ...
          price: `${monthlyPrice(EXTRA_WORKER)} each`,
          to: '/pricing#ai-workforce',
          linkLabel: 'See AI Workforce plans',
        },
      ],
    ...
    delivery: {
      ...
      items: [
        ...
        ),
        {
          ...
          price: monthlyPrice(MARKET_WATCH_PRICE),
          to: '/pricing#projects',
  ...
  },
  {
    ...
    delivery: {
      ...
      short: `Delivered as a Team AI Workshop: half day, up to 20 people, ${formatPrice(WORKSHOP_PRICE)}.`,
      items: [
        {
          ...
          price: formatPrice(WORKSHOP_PRICE),
          to: '/pricing#projects',
